...
#output: Raheem                is my good friend
#Return a 20 characters long, left justified version of the word "Raheem"
...
string = "hello I am Tanvir Ahmed.\n I love to play cricket. "
string = string.splitlines()
print(string)
#output: ['hello I am Tanvir Ahmed.', ' I love to play cricket. ']
